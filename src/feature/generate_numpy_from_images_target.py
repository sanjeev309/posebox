...
ANNOTATION_FILE = config.CLEAN_ANNOTATION_FILE
OUTPUT = config.EXTERNAL
...
"""
Read annotation file, fetch image, 
normalise image and array, 
compose data and target arrays
"""
